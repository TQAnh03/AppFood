...
public class FragMent_Home  extends Fragment implements SanPhamView {
    ...
    private ImageButton imgBtnDanhMuc,imgBtnUaThich,imgBtnDeal,imgBtnMomo, imgBtnGift;
...
//        imgBtnUaThich.setOnClickListener(view -> {
//            activityCallback.onButtonClick();
//        });
//        imgBtnDeal.setOnClickListener(view ->{
//            activityCallback.onButtonClick();
//        } );
//        imgBtnMomo.setOnClickListener(view ->{
//            activityCallback.onButtonClick();
//        });
...
///Tạo banner
    ...
    private void InitWidget() {
        ...
        imgBtnDeal = view.findViewById(R.id.home_btn_deal);
        imgBtnMomo = view.findViewById(R.id.home_vi);
    }
